...
csv_df.rename(columns={old_column: new_column for old_column, new_column in zip(csv_df.columns, columns)}, inplace=True)
...
similar_champions = cosine_sim_df[champion].sort_values(ascending=False)[1:num_champions + 1]
